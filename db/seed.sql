...
INSERT into employee (first_name, last_name, role_id, manager_id) VALUES ("Abdul M.", "Aba", 1, null);
...
INSERT into employee (first_name, last_name, role_id, manager_id) VALUES ("Sarah", "Walker", 4, 3);
INSERT into employee (first_name, last_name, role_id, manager_id) VALUES ("Chuck", "Bartowski", 4, 3);
...
INSERT into employee (first_name, last_name, role_id, manager_id) VALUES ("Bob", "The Builder", 7, 5);
INSERT into employee (first_name, last_name, role_id, manager_id) VALUES ("John", "Hope", 8, 5);

INSERT into employee (first_name, last_name, role_id, manager_id) VALUES ("Hannah", "Troi", 9, null);
